...
@Config
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "Red Wall - Full Cycle")
public class PatternAutoRedWall extends LinearOpMode {
    public static Pose score = new Pose(89, 90, Math.toRadians(225)); // Mirrored from (55, 90, 315)
    public static Pose wallStart = new Pose(89, 9.5, Math.toRadians(90)); // Mirrored from (55, 9.5, 270)
    public static Pose preGrab1  = new Pose(89, 55, Math.toRadians(0)); // Mirrored from (55, 55, 180)
    public static Pose grab1  = new Pose(119, 55, Math.toRadians(0)); // Mirrored from (25, 55, 180)
    public static Pose preGrab2  = new Pose(99, 80, Math.toRadians(0)); // Mirrored from (45, 80, 180)
    public static Pose grab2  = new Pose(119, 80, Math.toRadians(0)); // Mirrored from (25, 80, 180)
    public static Pose preGrab3  = new Pose(74, 20, Math.toRadians(180)); // Mirrored from (70, 20, 0)
    public static Pose grab3  = new Pose(10, 20, Math.toRadians(180)); // Mirrored from (134, 20, 0)
    public static Pose postGrab3 = new Pose(74,30,Math.toRadians(225)); // Mirrored from (70,30,315)
