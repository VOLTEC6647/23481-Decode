...
@Config
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "Red Goal - Full Cycle")
public class PatternAutoRedGoal extends LinearOpMode {
    public static Pose score = new Pose(89, 85, Math.toRadians(225)); // Mirrored from (55, 85, 315)
    public static Pose goalStart = new Pose(124, 120, Math.toRadians(215)); // Mirrored from (20, 120, 325)
    public static Pose preGrab1  = new Pose(89, 50, Math.toRadians(0)); // Mirrored from (55, 50, 180)
    public static Pose grab1  = new Pose(119, 50, Math.toRadians(0)); // Mirrored from (25, 50, 180)
    public static Pose preGrab2  = new Pose(99, 75, Math.toRadians(0)); // Mirrored from (45, 75, 180)
    public static Pose grab2  = new Pose(119, 75, Math.toRadians(0)); // Mirrored from (25, 75, 180)
    public static Pose preGrab3  = new Pose(74, 15, Math.toRadians(180)); // Mirrored from (70, 15, 0)
    public static Pose grab3  = new Pose(10, 15, Math.toRadians(180)); // Mirrored from (134, 15, 0)
    public static Pose postGrab3 = new Pose(74,20,Math.toRadians(225)); // Mirrored from (70,20,315)
    public static Pose end = new Pose(74,70,Math.toRadians(225)); // Mirrored from (70,70,315)
